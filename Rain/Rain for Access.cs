...
namespace Rain
{
    ...
    {
        /// <summary>
        /// Rain Engine per Access
        /// </summary>
        public class RainEngine
        {
            private OleDbConnectionStringBuilder string_builder = null;
            ...
            /// <param name="path"> Path assoluto del database a cui bisogna collegarsi </param>
             public RainEngine(string path)
            {
                string_builder = new OleDbConnectionStringBuilder();
                // Imposto i parametri di connessione per la connection string
                string_builder.DataSource = path;
                string_builder.Provider = "Microsoft.ACE.OLEDB.12.0";
            }
