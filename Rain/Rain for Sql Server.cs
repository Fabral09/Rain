...
namespace Rain
{
    ...
    {
        /// <summary>
        /// Rain Engine per SQL Server
        /// </summary>
        public class RainEngine
        {
            private SqlConnectionStringBuilder string_builder = null;
            ...
            /// <param name="hostname"> Nome dell'istanza SQL Server a cui bisogna collegarsi </param>
            ...
            {
                string_builder = new SqlConnectionStringBuilder();
                // Imposto i parametri di connessione per la connection string
                string_builder.DataSource = hostname;
                string_builder.InitialCatalog = dbname;
